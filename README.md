...
The goal of regexcite.mi is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the released version of regexcite.mi from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("regexcite.mi")
```

And the development version from [GitHub](https://github.com/) with:
<https://github.com/miyer26/regexcite.mi>

``` r
# install.packages("devtools")
devtools::install_github("miyer26/regexcite.mi")
```
...
That’s exactly what `regexcite.mi::str_split_one()` does.
