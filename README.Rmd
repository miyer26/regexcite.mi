...
You can install the released version of regexcite.mi from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("regexcite.mi")
```

And the development version from [GitHub](https://github.com/) with: https://github.com/miyer26/regexcite.mi
